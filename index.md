...
*   **Systems Administration:** Windows/Linux VM management, WAMP stack deployment.
*   **Networking Fundamentals:** DHCP, Subnetting, OSI Model, ICMP, and Host-to-VM connectivity.
*   **Troubleshooting:** Root cause analysis, kernel-level virtualization error resolution.
*   **Infrastructure as Code:** Version control via Git/GitHub for configuration management.
